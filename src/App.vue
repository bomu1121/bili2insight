...
import { NInput, NButton, NSpace, NProgress, NText, NIcon, NScrollbar, createDiscreteApi, NDrawer, NDrawerContent, NTabs, NTabPane, NTag, NSelect } from "naive-ui";
